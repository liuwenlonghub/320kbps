...
import { flacToMp3InBrowser } from "@/lib/ffmpeg/presets/flac-to-mp3-browser";

type FlacToMp3BrowserProps = {
  file: File | null;
  bitrate: number;
  outputFilename: string;
};

export function FlacToMp3Browser({
  file,
  bitrate,
  outputFilename,
}: FlacToMp3BrowserProps) {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      const blob = await flacToMp3InBrowser(
        file,
        bitrate,
        (value) => {

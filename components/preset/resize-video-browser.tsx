...
import { resizeVideoInBrowser } from "@/lib/ffmpeg/presets/resize-video-browser";

type ResizeVideoBrowserProps = {
  file: File | null;
  width: number;
  outputFilename: string;
};

export function ResizeVideoBrowser({
  file,
  width,
  outputFilename,
}: ResizeVideoBrowserProps) {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      const blob = await resizeVideoInBrowser(
        file,
        width,
        (value) => {

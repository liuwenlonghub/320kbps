...
import { compressVideoInBrowser } from "@/lib/ffmpeg/presets/compress-video-browser";

type CompressVideoBrowserProps = {
  file: File | null;
  quality: "high" | "balanced" | "small";
  outputFilename: string;
};

export function CompressVideoBrowser({
  file,
  quality,
  outputFilename,
}: CompressVideoBrowserProps) {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      const blob = await compressVideoInBrowser(
        file,
        quality,
        (value) => {
